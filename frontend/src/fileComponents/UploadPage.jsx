...
const UploadPage = ({ onBack }) => {
  ...
  const [selectedFile, setSelectedFile] = useState(null); // No File | null type annotation
  const [isDragging, setIsDragging] = useState(false);
  const [isUploading, setIsUploading] = useState(false);
  const [uploadStatus, setUploadStatus] = useState("idle"); // No "idle" | "success" | "error" type annotation
  ...
  // Type assertion `as keyof typeof coursesBySemester` is removed
  ...
  return (
    <div className="min-h-screen w-full h-full bg-gradient-to-br from-gray-900 via-blue-900 to-black-900 flex flex-col p-0">
      ...
      <motion.div
        ...
        className="bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl border border-gray-700 p-8 mx-8 flex-1"
      >
        ...
        <motion.div
          ...
          className="mt-8 bg-gray-800 bg-opacity-30 backdrop-filter backdrop-blur-xl rounded-xl border border-gray-700 p-6"
        >
          ...
          <ul className="space-y-2 text-gray-300 text-sm">
            ...
            <li className="flex items-start space-x-2">
              <span className="text-green-400 mt-1">•</span>
              <span>
                Select the correct semester and course for proper categorization
              </span>
            </li>
          </ul>
        </motion.div>
